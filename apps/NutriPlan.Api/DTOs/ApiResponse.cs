...
public record ApiResponse<T>(bool Success, T? Data = default, string? Error = null, string? Message = null, List<FieldError>? Details = null);

public record ApiResponse(bool Success, string? Error = null, string? Message = null, List<FieldError>? Details = null);
